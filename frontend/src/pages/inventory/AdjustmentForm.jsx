                ...
                <table className="w-full border border-gray-200 rounded-lg">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-2 text-left text-xs font-semibold text-gray-700">Qty Delta</th>
                      <th className="px-4 py-2 text-left text-xs font-semibold text-gray-700">UoM</th>
                      <th className="px-4 py-2 text-left text-xs font-semibold text-gray-700">Note</th>
