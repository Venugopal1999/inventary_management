    ...
    <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-0">
      ...
      <div className="mb-4 sm:mb-6">
        <button
          ...
          className="flex items-center gap-1 sm:gap-2 text-gray-600 hover:text-gray-900 mb-3 sm:mb-4 text-sm sm:text-base"
        >
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6 mb-4 sm:mb-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 mb-4">
            ...
            <button
              ...
              className="flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 bg-[#FF9900] hover:bg-orange-600 text-white rounded-md transition text-sm sm:text-base w-full sm:w-auto justify-center"
            >
              ...
              <div className="hidden sm:block overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      <th className="px-3 sm:px-4 py-2 sm:py-3 text-left text-xs font-semibold text-gray-700 uppercase">
                        Product
                      </th>
                      <th className="px-3 sm:px-4 py-2 sm:py-3 text-left text-xs font-semibold text-gray-700 uppercase">
                        Qty
                      ...
                      <th className="px-2 py-2 sm:py-3"></th>
                    </tr>
                  </thead>
                      ...
                      <tr key={index}>
                        ...
                        <td className="px-3 sm:px-4 py-2 sm:py-3">
                          <input
                            ...
                            className="w-20 px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-[#FF9900] focus:border-transparent"
                            required
                          />
                        </td>
                        <td className="px-3 sm:px-4 py-2 sm:py-3">
                          <input
                            ...
                            className="w-24 px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-[#FF9900] focus:border-transparent"
                            required
                          />
                        </td>
        ...
        <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 sm:gap-4">
          <button
            type="button"
            onClick={() => navigate('/sales-orders')}
            className="w-full sm:w-auto px-4 sm:px-6 py-2 border border-gray-300 rounded-md hover:bg-gray-50 transition text-sm sm:text-base"
            disabled={loading}
          >
            Cancel
          </button>
          <button
            type="submit"
            className="w-full sm:w-auto px-4 sm:px-6 py-2 bg-[#FF9900] hover:bg-orange-600 text-white rounded-md transition disabled:opacity-50 text-sm sm:text-base"
            disabled={loading}
          >
